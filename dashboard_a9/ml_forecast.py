    ...
    st.markdown(
        ...
        <div class="forecast-model-summary">
          ...
          <div class="forecast-model-recipes">
            <div class="forecast-model-recipe"><div class="forecast-model-recipe-title">F&oacute;rmula vencedora &middot; Conta</div><strong>60%</strong> ritmo hist&oacute;rico do canal + <strong>25%</strong> M-1 + <strong>15%</strong> m&eacute;dia dos &uacute;ltimos 3 meses. Se o target parcial ainda n&atilde;o chegou, a demanda projetada funciona como conting&ecirc;ncia.</div>
